...
export const TopBar = ( {changePage} ) => {
    ...
    const handleButtonClick = () => {
        navigate('/dashboard/meeting/managepracticetasks');  
      };
  return (
    <div className='w-[1430px] h-auto  bg-[#141518]'>
        <Box className='w-full h-[50px] border-b-[0.5px] py-[10px] flex items-center justify-between flex-row gap-[10px]'>
            <div className='w-[480px] h-[30px] py-[5px] px-[20px] gap-[9px] flex flex-row items-center justify-center'>
                ...
                <img src={arrow2} className='w-[20px] h-[20px] '/>
                <div className='w-auto h-[20px] flex items-center flex-row gap-[10px] '>
                    <img src={createnew} className='w-[20px] h-[20px] '/>
                    <label className='w-auto h-[16px] font-[Nunito] font-bold text-[12px] leading-[16px] text-white'>Create New Practice</label>
                </div>
            </div>
