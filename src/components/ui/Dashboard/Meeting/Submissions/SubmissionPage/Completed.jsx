...
export const Completed = ( {changePage} ) => {
  return (
    <div className='w-full h-[380px] p-[20px] rounded-[15px] border border-gray-800 bg-[#141518] flex flex-col gap-[20px]'>
        <button className='w-[131px] h-[40px] py-[10px] px-[10px] border border-gray-800 rounded-[10px] flex items-center flex-row gap-[10px] '>
            <IoIosArrowDown className="w-[20px] h-[20px] text-[#E6C100]"/>
            <label className='w-[61px] h-[16px] font-[Nunito] font-bold text-[12px] leading-[16px] text-[#E6C100]'>Completed</label>
        </button>
        <div className='w-full h-[280px]  flex justify-between'>
          <div className='w-[1050px] h-full flex flex-col gap-[20px]'>
            ...
            <div key={index} className='w-full  h-[30px] flex flex-row gap-[20px]'>
                ...
                <button onClick={() => changePage('ManageTaskwiseView')}  className=" w-[240px] h-full flex flex-row items-center gap-[5px] ">
